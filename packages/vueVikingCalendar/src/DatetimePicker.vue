...
<template>
  <div class="hash-calendar"
       ...
       :style="{'height': `${model === 'inline' ? 440 + (isShowArrowImg ? 30 : 0) : undefined}px`}"
       @click="close">
    <div class="calendar_content"
         :style="{'height': `${440}px`, 'bottom': `${isShowArrowImg ? 30 : 0}px`}"
         @click.stop>
      <div class="calendar_title"
        ...
        <slot name="action">
          <div class="calendar_title_date">
            <div class="calendar_title_back" v-if="isShowWeek" @click="toggleWeek"><img :src="arrowBackImg" alt=""></div>
            <span v-if="pickerType !== 'time'"
                  class="calendar_title_date_year"
                  style="vertical-align: middle;"
                  :class="{'calendar_title_date_active': isShowCalendar}"
                  @click="showCalendar">{{ formatDate(`${checkedDate.year}/${checkedDate.month + 1}/${checkedDate.day}`, language.DEFAULT_DATE_YEARMONTH) }}</span>
          ...
          <div class="titleDownImg"  v-if="!isShowWeek" ><img :src="titleDownImg" alt=""></div>
          </div>
      ...
      <year-month-picker v-if="changeYearFast"
                         :calendarTitleHeight="calendarTitleHeight"
                         :calendarContentHeight="62.5 + calendarContentHeight/4"
                         :calendarDate="checkedDate"
                         @touchstart="touchStart"
                         @touchmove="touchMove"
                         @touchend="touchEnd"
...
import { ARROW_DOWN_IMG, ARROW_UP_IMG, ARROW_BACK_IMG, DOWN_IMG } from '../constant/img'
